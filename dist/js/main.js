$(document).ready(function() {
    ...
    $.ajax({url: "https://spreadsheets.google.com/feeds/list/1J9RVuxRU_5MDO1K0FAucTNN0tvf5N7XVQuDH7TR9Bgg/default/public/values?alt=json", success: function(result){
        ...
        for (var i=0;i<data.length;i++) {
        	...
        	$('#board').append('<div class="entity col-3"><div class="entity-image"><img src="assets/images/'+logo+'"></div><a target="_new" class="btn" href="https://twitter.com/intent/tweet?text='+tweet+'"><img src="assets/images/twitter_white.svg" width:20px;"> Tweet</a></div>');
        }
        $('#dots').hide();
    }});
})